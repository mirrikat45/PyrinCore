<?php
namespace Pyrin\Core\Render\PDF\TCPDF;
use Pyrin\Core\Render\PDF\TCPDF\TCPDF_FONT_DATA;
use Pyrin\Core\Render\PDF\TCPDF\TCPDF_STATIC;
//============================================================+
...
class TCPDF_FONTS {
	...
	public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
		if ($isunicode) {
			return array_map(array('Pyrin\Core\Render\PDF\TCPDF\TCPDF_FONTS', 'unichrUnicode'), $ta);
		}
		return array_map(array('Pyrin\Core\Render\PDF\TCPDF\TCPDF_FONTS', 'unichrASCII'), $ta);
	}
	...
	public static function UTF8StringToArray($str, $isunicode=true, &$currentfont) {
		if ($isunicode) {
			...
			$carr = array_map(array('Pyrin\Core\Render\PDF\TCPDF\TCPDF_FONTS', 'uniord'), $chars);
		} else {
			$chars = str_split($str);
